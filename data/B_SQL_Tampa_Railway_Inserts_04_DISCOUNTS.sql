...
GO
INSERT [dbo].[discounts] ([discount_id], [name], [percentage], [observations], [start_date], [end_date]) VALUES (4, N'AmazonPrime Customers Discount', CAST(0.25 AS Decimal(5, 2)), N'Validate Prime membership', CAST(N'2019-01-06' AS Date), NULL)
GO